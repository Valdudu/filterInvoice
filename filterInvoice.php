...
class FilterInvoice extends Module
{
    protected $config_form = false;

    public function __construct()
    {
        $this->name = 'filterInvoice';
        ...
        $this->displayName = $this->l('Filtre factures');
        $this->description = $this->l('Génère une liste de facture par date et par état');
